                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-primary">
                            ...
                            <a href="orders.php" class="btn btn-success float-end"><i class="fa fa-reply"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="border p-1 mb-3">
                                        ...
                                        <div class="border p-1 mb-2">
                                           Payment Type: <?= $data['payment_mode']; ?>
                                        </div>
                                        <div class="border p-1 mb-2">
                                        ...
                                        <div class="border p-1">
                                            <form action="code.php" method="POST">
                                                ...
                                                <select name="order_status" class="form-select">
                                                    ...
                                                    <option value="3" <?= $data['status'] == 3 ? "selected" : "" ?>>Out for Delivery</option>
                                                    <option value="1" <?= $data['status'] == 1 ? "selected" : "" ?>>Completed</option>
                                                    <option value="2" <?= $data['status'] == 2 ? "selected" : "" ?>>Cancelled</option>
                                                </select>
                                                <button type="submit" name="update_order_btn" class="btn btn-sm float-end mt-3 btn-primary">Update Status</button>
                                            </form>
                                        </div>
                                    </div>
