...
require_once 'admin/includes/mpdf/vendor/autoload.php';
...
if (isset($_GET['t'])) {
    ...
    $mpdf->WriteHTML('<h2 style="text-align: center;color:#9f4103;">Yaasikaa Enterprises</h2>');
    $mpdf->WriteHTML('<h4 style="text-align: center;color:#9f4103;">287,288/W4,BOSE BAZAAR,BODINAYAKANUR,Tamil Nadu</h4>');
    $mpdf->WriteHTML('<h4 style="text-align: center;color:#9f4103;">GSTIN: 33BEOPP1211H2ZQ</h4>');
    $mpdf->WriteHTML('<h4 style="text-align: center;color:#9f4103;">Tax Invoice</h4>');
