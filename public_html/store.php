    ...
    <div class="row">
        ...
        <div class="col-lg-7 py-4">
            <div class="row">
                ...
                <!-- Pagination topic -->
                <?php
                $pagination = $sql = "SELECT * FROM products";
                $run_q = mysqli_query($con, $pagination);
                $total_product = mysqli_num_rows($run_q);
                $limit = 8;
                ...
                ?>
                    <ul class="pagination pt-2 pb-5">
                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                            <li class="page-item px-1 <?= ($i == $page) ? $active = "active" : ""; ?>">
                                <a href="store.php?page=<?= $i ?>" class="page-link"><?= $i ?></a>
                            </li>
                        <?php } ?>
                    </ul>
                <?php } ?>
